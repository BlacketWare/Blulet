...
stopLoading()
    ...
    .then(response => {
        ...
        auctions.forEach(Object => {
            blulet.blues.forEach(obj => {obj.blues.forEach(capsule => {if (capsule.name === Object[1].blue) { capsulename =  obj.name }})})
                ...
                <div class="styles__auctionContainer___3RwSU-camelCase" id="${Object[0]}" role="button" style="background-image: url(/media/capsules/${capsulename}/media/misc/background.png)">
                     <div class="styles__auctionImgContainer___3NABW-camelCase"><img src="/media/capsules/${capsulename}/blues/${Object[1].blue}.png" class="styles__auctionImg___3to1S-camelCase"></div>
                     ...
                     <div class="styles__auctionTop___37drt-camelCase">${Object[1].blue} x${Object[1].amount}</div>
                     </div>
                `)
            ...
            document.getElementById(`${Object[0]}`).onclick = () => {
                let bids = ""
                blulet.blues.forEach(obj => {
                    obj.blues.forEach(capsule => {
                        if (capsule.name === Object[1].blue) {
        ...
        <div class="styles__bluesBackground___3oQ7Y-camelCase" style="background-image: url(&quot;/media/misc/background.png&quot;);  animation: animatedBackground 9s linear infinite;
        ...
        -o-animation: animatedBackground 9s linear infinite;"></div>
            ...
            <div style="position:relative;right:150px;color: #fff;font-family: 'Titan One',sans-serif;" id="bids"><text style="position:relative;left: 150px;font-size: 50px;">Bids</text><br>${bids}</div>
                     ...
                     document.getElementById("bid").onclick = () => {
                        ...
                        if (Object[1].user === blulet.userdata.username) {
                            $('body').append(`
...
document.getElementById("okay").onclick = () => {
    $('#errorprompt').remove()
                                    ...
                                    indexToDelete = Object[1].bids.findIndex(bid => bid.user === blulet.userdata.username);
                                    ...
                                    if (indexToDelete >= 0) {
                                      Object[1].bids.splice(indexToDelete, 1);
                                                                ...
                                                                auctionsorwhatever.push({user: `${blulet.userdata.username}`,bid: Number(bid)});

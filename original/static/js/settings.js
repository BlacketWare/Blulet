...
$(function reset() {
    ...
    let date = new Date(blulet.userdata.joined)
    let splited = date.toLocaleString('en-GB', {
        day: 'numeric',
        month: 'long',
        year: 'numeric'
    }).split(" ")

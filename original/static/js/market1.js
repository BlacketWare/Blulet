...
`)
                        ...
                        $('body').append(`
    <div id="capsuleContainer" class="capsuleContainer"><div id="overlay" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; opacity: 0; z-index: 10000000; cursor: pointer;"></div><div id="background" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; background: radial-gradient(circle, #${capsule.colors[0]}, #${capsule.colors[1]}); z-index: 8;"></div><div id="capsule" class="trianglecontainer"><img id="capsuletop"class="capsuletop" src="media/capsules/other/top.png"><img src="/media/capsules/${capsule.name}/bottom.png"></div></div>
    `)
  ...
  `)
            ...
            let refMiddle = refRect.top + window.scrollY + refRect.height / 2;
        ...
        `)
                            ...
                            fetch('/data/user', {
                                ...
                                .then(response => document.getElementById("tokenbalance").innerText = response.tokens.toLocaleString("en-US"))
                            $('body').append(`
            <div id="capsuleContainer" class="capsuleContainer"><div id="overlay" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; opacity: 0; z-index: 10000000; cursor: pointer;"></div><div id="background" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; background: radial-gradient(circle, #${capsule.colors[0]}, #${capsule.colors[1]}); z-index: 8;"></div><img src="/media/capsules/${capsule.name}/icon.png" class="styles__cornerIcon___24o3Z-camelCase"><div id="capsule" class="trianglecontainer"><img id="capsuletop"class="capsuletop" src="media/capsules/other/top.png"><img src="/media/capsules/${capsule.name}/bottom.png"></div></div>
            `)
